...
class _$_EmployeeModel implements _EmployeeModel {
  ...
  @override
  String toString() {
    return 'EmployeeModel(createdAt: $createdAt, name: $name, avatar: $avatar, email: $email, phone: $phone, department: $department, birthday: $birthday, country: $country, id: $id)';
  }
...
abstract class _EmployeeModel implements EmployeeModel {
  const factory _EmployeeModel(
      ...
      final DateTime? birthday,
      final String? country,
      final String? id}) = _$_EmployeeModel;
